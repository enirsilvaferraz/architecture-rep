...
final class JPQLFactory {
	...
	/**
	 * M�todo usado para realizar a montagem da parte da connsulta JPQL
	 * referente a associa��o
	 * 
	 * @param nomeObjeto
	...
	/**
	 * M�todo usado na montagem do corpo da consulta (SELECT)
	 * 
	 * @param pModel
	 *            Objeto principal da consulta
	 * @param nomeObjeto
	 *            nome padr�o para esse objeto
	 * @param jpqlPrincipal
	...
	/**
	 * M�tod usado para inserir uma condi��o LIKE de pesquisa
	 * 
	 * @param jpqlWhere
	...
	/**
	 * M�tod usado para inserir uma condi��o gen�rica de pesquisa
	 * 
	 * @param jpqlWhere
	 *            para montagem da parte da consulta referente as clausulas
	 *            WHERE
	...
	/**
	 * M�tod usado para inserir uma condi��o de DATE de pesquisa
	 * 
	 * @param jpqlWhere
	 *            para montagem da parte da consulta referente as clausulas
	 *            WHERE
	...
	/**
	 * M�todo usado para obter o valor a partir de um field
	 * 
	 * @throws NegocioException
	 *             ERRO_GERAL
	 */
	...
	/**
	 * M�todo usado para obter o valor a partir de um nome de field
	 * 
	 * @throws NegocioException
	 *             ERRO_GERAL
	 */
