package com.archtecture.control.util;
...
public final class JPQLFactory {
	 ...
	 *            nome do field
	 */
	private static void inserirClausulaJoinFetch(String nomeObjeto, StringBuilder jpqlAssociacao, Field field, String nomeObjetoAb) {
	...
	private static <Model> StringBuilder inserirClausuraOrderBy(Model pModel, String nomeObjeto, TipoOrdenacao tipoOrdenacao,
	...
	private static <Model> StringBuilder inserirClausuraWhere(Model pModel, String nomeObjeto) throws NegocioException {
	 ...
	 *            valor da variável
	 */
	private static void inserirParametroClausulaLike(StringBuilder jpqlWhere, String nomeObjeto, String nomefield, Object valor) {
	 ...
	 *            valor da variável
	 */
	private static void inserirParametroGenerico(StringBuilder jpqlWhere, String nomeObjeto, String nomefield, Object valor) {
	 ...
	 * @return JPQL montado
	 */
	public static <Model> String montarConsultaJPQLResultadoUnico(Model pModel) throws NegocioException {
	 ...
	 *             ERRO_GERAL
	 */
	private static <Model> Object obterValor(Model pModel, Field pField) throws NegocioException {
		...
		try {
			...
			throw new NegocioException(Mensagem.ERRO_AMBIENTE, e);
		}
	}
	 ...
	 *             ERRO_GERAL
	 */
	private static <Model> Object obterValor(Model pModel, String pFieldName) throws NegocioException {
